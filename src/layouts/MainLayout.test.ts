...
describe("MainLayout", () => {
  ...
  it("describes the site-wide Open Graph image", async () => {
    expect(await render()).toContain(
      '<meta property="og:image:alt" content="Illustrated portrait of Astro in front of a neon skyline at night, beside social links: github.com/eugencowie and x.com/eugencowie">',
    );
  });
